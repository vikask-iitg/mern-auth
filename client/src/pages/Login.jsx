    ...
    >
      ...
      >
        ...
        <form onSubmit={onSubmitHandler}>
          {state === "Sign Up" && (
            ...
            >
              ...
              <input
                ...
                value={name}
                className="bg-transparent appearance-none outline-none text-white placeholder-gray-400 w-full"
                type="text"
          ...
          <button
            className="w-full py-2.5 rounded-full bg-linear-to-r from-indigo-500
           to-indigo-900 text-white font-medium cursor-pointer"
          >
            {state}
          </button>
        </form>
